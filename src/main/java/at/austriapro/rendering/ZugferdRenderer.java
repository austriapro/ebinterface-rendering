 ...
 */
public class ZugferdRenderer {

  private String xmlDatePattern = "yyyy-MM-dd'T'HH:mm:ss";
  private String xmlNumberPattern = "#,###,##0.##";
  private Locale xmlLocale = Locale.ENGLISH;

  private Locale reportLocale = Locale.GERMAN;
  private String reportLanguage = "de";
  private String reportTitle = "ZUGFeRD";
  private String reportAuthor = "Mustermann GmbH";
  private String reportSubject = "Invoice";
  ...
  public byte[] renderReport(byte[] jasperTemplate, byte[] zugferdXML, InputStream logo)
    ...
    parameters.put(JRXPathQueryExecuterFactory.PARAMETER_XML_DATA_DOCUMENT, JRXmlUtils
        .parse(new ByteArrayInputStream(zugferdXML)));
    ...
    //Not set because of PDFA_1A conformance issues
